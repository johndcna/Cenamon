...
export default function Contact() {
        ...
        return (
            <div id="contact" className="container-fluid text-center" style={{ paddingBottom: "3%", backgroundColor: "#f5f5f5" }}>
                ...
                <hr className="solid" />
                <a href="#section2" className="topButton"><span className="material-icons" >arrow_upward</span></a>
                {/*<p style="color: #67676e;;">Feel free to contact me.</p>*/}
                {/*<!---Add your phone number at the end like (https://api.whatsapp.com/send?phone=12345678901)-->*/}
                <a href="https://api.whatsapp.com/send?phone=" style={{ backgroundColor: "#25D366" }} className="contactIcons"><i className="fa fa-whatsapp"></i></a>
